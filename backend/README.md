...
## Project Structure
    ...
    ├── testapiautostoryboa_96397  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_96397`
...
2. Clone this repo and `cd testapiautostoryboa_96397`
